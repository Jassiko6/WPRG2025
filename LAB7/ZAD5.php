...
<body>
    ...
    <hr>
    <h3>Prosty</h3>
    <form name="f1" method="POST" action="ZAD5.php">
        <p>
    ...
    <hr>
    <form name="f2" method="POST" action="ZAD5.php">
        <h3>Zaawansowany</h3>
        <p>
...
if (isset($_POST['kz_l']) && isset($_POST['kz_o'])) {
    $input = $_POST['kz_l'];
        ...
        case 'DziesSzes':
            if (is_numeric($input)) {
                switch ($operation) {
                    ...
                    case 'DziesSzes': echo dechex($input); break;
                }
            } else {
